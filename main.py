...
def runKMeans():
    ...
    centroid_values = []
    centroid_values.append(9)
    centroid_values.append(2)
    centroid_values.append(1)
    centroid_values.append(4)
    centroid_values.append(3)
    centroid_values.append(0)
    centroid_values.append(8)
    centroid_values.append(6)
    centroid_values.append(5)
    centroid_values.append(7)
    test_Kmeans(kmeans_model, test_data, centroid_assignments = centroid_values)
